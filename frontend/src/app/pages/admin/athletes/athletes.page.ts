...
export class AthletesPage implements OnInit {
  ...
  addToTeam = signal<apiTeamsOutputDetailModel | null>(null);
      ...
      this.apiAthlete
        ...
        .subscribe({
          ...
          error: (error) => {
            ...
            this.toastService.showError('Failed to load athlete data');
          },
          complete: () => {
            this.dataLoaded.set(true);
          },
        ...
        this.apiAthlete
          ...
          .subscribe({
            ...
            error: (error) => {
              ...
              this.toastService.showError('Failed to update athlete');
            },
          });
      } else {
        // Create Athlete
        this.apiAthlete
          .createAthleteAthletesPost({
            body: {
              ...
              team_id: this.addToTeam()!.id,
            },
          })
          .subscribe({
            next: (data) => {
              this.toastService.showSuccess('Athlete created successfully');
              this.router.navigate(['admin', 'teams', this.addToTeam()!.id], {
                replaceUrl: true,
              });
            },
            error: (error) => {
              console.error('Error creating athlete:', error);
              this.toastService.showError('Failed to create athlete');
            },
          });
      }
    }
      ...
      this.apiAthlete
        ...
        .subscribe({
          ...
          error: (error) => {
            ...
            this.toastService.showError('Failed to delete athlete');
          },
        });
    }
  }
