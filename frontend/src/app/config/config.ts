      ...
      },
      {
        ...
        categoryWodDescription: {
          Open: [
            ...
            '',
            'Only one teammate can accumulate repetitions at a time, non-working teammates - 100 kg (50+50) Double Barbell Hold',
            '',
            ...
            '',
            '* Teammates can switch between movements at any time, there is no minimum work requirement for any teammate. ',
          ...
          Intermediate: [
            ...
            '',
            'Only one teammate can accumulate repetitions at a time, non-working teammates - 80 kg (40+40) Double Barbell Hold',
            '',
            'The score is the number of Repetitions completed at the 15 minute mark. ',
            'The time at the completion of push ups will be noted for tie breaks.',
            '',
          ...
          Beginner: [
            'In 15 Minutes complete as many Repetitions as possible of: ',
            '50 Calorie Row',
            '50 Renegade Rows @ 10kg',
            '50 Calorie Air Bike',
            '35 Hand Release Push-Ups from the Knees',
            'Max Lying to Standing Rope Climbs',
            '',
            'Only one teammate can accumulate repetitions at a time, non-working teammates - 60 kg (30+30) Double Barbell Hold',
            '',
            'The score is the number of Repetitions completed at the 15 minute mark. ',
            'The time at the completion of push ups will be noted for tie breaks.',
            '',
      ...
      },
      {
        ...
        categoryWodDescription: {
          Open: [
            ...
            '* The Double Unders may be split anyhow between Athlete 3 and Athlete 4.',
            '* Teammates may switch between Shuttle Runs and Double Unders ONLY AFTER a 3-minute round is complete.',
            "* A F/M Pair MUST perform the devil's press in sync. Working teammates on the devil's press may switch at any time, as long as the working pair remains as 1F and 1M. There is no minimum work requirement on any teammate, except the alternating shuttle run rule.",
          ],
          Intermediate: [
            'For Time:',
          ...
          Beginner: [
            ...
            '* The Shuttle Runs MUST be completed with both Athlete 1 and Athlete 2 alternating the runs. 1 Shuttle Run = 25ft out and back.',
            '* The Single Unders may be split anyhow between Athlete 3 and Athlete 4.',
      ...
      },
      {
        ...
        categoryWodDescription: {
          Open: [
            ...
            'Cleans @ ♀ 45kg / ♂ 70kg',
            '',
            'Score is Total Time at completion.',
            '',
            '* ONLY ONE teammate works at one time on the Wall Walks and the Cleans. Teammates may switch at any time.',
            '* ONLY ONE barbell MUST be off the floor at one time. The repetitions may be split between Male and Female teammates. There is no minimum work requirement for any one teammate on the wall walks or the cleans.',
          ...
          Beginner: [
            ...
            'Score is Total Time at completion.',
            '',
            '* ONLY ONE teammate works at one time on the Bear Crawls and the Cleans. Teammates may switch at any time.',
            '* ONLY ONE barbell MUST be off the floor at one time. The repetitions may be split between Male and Female teammates. There is no minimum work requirement for any one teammate on the bear crawls or the cleans.',
